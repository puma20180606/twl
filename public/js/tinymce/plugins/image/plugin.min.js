...
{function t(t)
	...
	//t.onload=function(){n.width||n.height||g.setAttribs(t,{width:t.clientWidth,height:t.clientHeight}),i()},t.onerror=i}
	t.onload=function(){n.width||n.height||g.setAttribs(t,{width:imageWidth,height:imageHeight}),i()},t.onerror=i}
if(''==serverUploadfile){
	setTimeout(a,1000);
	return;
}
